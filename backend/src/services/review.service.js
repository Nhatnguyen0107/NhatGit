...
class ReviewService {
    ...
    async createReview(data) {
        ...
        // Return review with customer info for immediate display
        const reviewWithCustomer = await this.repository.findById(review.id, {
            include: [
                {
                    model: db.Customer,
                    as: 'customer',
    ...
    async hasUserReviewed(productId, customerId) {
        const existingReview = await this.repository.findOne({
