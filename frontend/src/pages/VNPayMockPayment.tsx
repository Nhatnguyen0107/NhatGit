...
const VNPayMockPayment: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(async () => {
            try {
                ...
                const response = await api.post('/payments/vnpay/confirm', {
                    orderId,
                    orderCode
                });
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-red-50 
                    ...
                    {status === 'processing' && (
                        <div className="mb-6">
                            ...
                            <div className="w-full bg-gray-200 rounded-full h-2 
                                overflow-hidden">
                                <div className="h-full bg-gradient-to-r from-red-500 
                                    to-orange-500 animate-loading"></div>
                            </div>
                        </div>
                    )}
