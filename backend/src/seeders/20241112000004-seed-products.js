    ...
    async up(queryInterface, Sequelize) {
        await queryInterface.bulkInsert('products', [
            // Laptops (Category 1)
            {
                ...
                category_id: 1,
                brand: 'Dell',
                image_url: 'https://via.placeholder.com/400x300?text=Dell+XPS+13',
                is_active: true,
            ...
            },
            {
                ...
                brand: 'Apple',
                image_url:
                    'https://via.placeholder.com/400x300?text=MacBook+Pro',
                is_active: true,
            ...
            },
            {
                ...
                category_id: 1,
                brand: 'HP',
                image_url: 'https://via.placeholder.com/400x300?text=HP+Pavilion',
                is_active: true,
            ...
            },
            {
                ...
                category_id: 1,
                brand: 'ASUS',
                image_url: 'https://via.placeholder.com/400x300?text=ROG+Strix',
                is_active: true,
            ...
            // Desktop PCs (Category 2)
            {
                ...
                brand: 'Custom Build',
                image_url:
                    'https://via.placeholder.com/400x300?text=Gaming+PC',
                is_active: true,
            ...
            },
            {
                ...
                brand: 'Dell',
                image_url:
                    'https://via.placeholder.com/400x300?text=OptiPlex',
                is_active: true,
                discount_percentage: 0,
                created_at: new Date(),
                updated_at: new Date()
            },
            {
                ...
                category_id: 2,
                brand: 'HP',
                image_url: 'https://via.placeholder.com/400x300?text=HP+Elite',
                is_active: true,
                discount_percentage: 5,
                created_at: new Date(),
                updated_at: new Date()
            ...
            // Monitors (Category 3)
            {
                ...
                brand: 'LG',
                image_url:
                    'https://via.placeholder.com/400x300?text=LG+UltraGear',
                is_active: true,
                discount_percentage: 10,
                created_at: new Date(),
                updated_at: new Date()
            },
            {
                ...
                brand: 'Samsung',
                image_url:
                    'https://via.placeholder.com/400x300?text=Odyssey+G7',
                is_active: true,
                discount_percentage: 15,
                created_at: new Date(),
                updated_at: new Date()
