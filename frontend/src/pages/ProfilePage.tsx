...
const ProfilePage: React.FC = () => {
    ...
    const handleUsernameChange = async () => {
        ...
        try {
            ...
            // Update profile state directly from response
            const updatedProfile = response.data?.data || response.data;
            if (updatedProfile) {
                setProfile(updatedProfile);
            }

            // Refresh context to update Navbar (don't let this error affect success message)
            try {
    ...
    const handleAvatarUpload = async () => {
        ...
        try {
            ...
            await api.post('/customers/profile/avatar', formData, {
                headers: {
